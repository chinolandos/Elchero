...
import { AvatarCircularPicker } from './avatar-circular-picker';
  ...
  return (
    <section className="glass-strong relative mb-8 overflow-hidden rounded-3xl p-6 md:p-8">
      ...
      <div className="relative flex flex-col items-center text-center">
        {/* Avatar clickeable — abre file picker DIRECTO (sin navegar a
            personalizacion). Maneja preview, validacion, upload, refresh. */}
        <AvatarCircularPicker
